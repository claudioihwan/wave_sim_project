def layout(content = "", script = ""):
  return f"""
    <html>
      ...
      <body>
        <div class="w-full min-h-screen flex flex-col items-center justify-center bg-[url(https://simplehomemadegifts.com/wp-content/uploads/2013/01/BlackChalkboardBackgroundSmall-1.jpg)] text-white md:p-4" style="font-family: 'Poppins', sans-serif;">
          {content}

def layout(content = "", script = ""):
  return f"""
    <html>
      ...
      <body>
        <div class="w-full min-h-screen flex flex-col items-center justify-center bg-[url(https://cdn.pixabay.com/photo/2020/07/31/03/34/planet-5451866_960_720.jpg)] bg-contain text-white md:p-4" style="font-family: 'Poppins', sans-serif;">
          {content}

def layout(content = "", script = ""):
  return f"""
    <html>
      ...
      <body>
        <div class="w-full min-h-screen flex flex-col items-center justify-center bg-[url(https://images4.alphacoders.com/167/thumb-1920-1676.jpg)] text-black md:p-4" style="font-family: 'Poppins', sans-serif;">
          {content}

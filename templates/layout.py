def layout(content = "", script = ""):
  return f"""
    <html>
      ...
      <body>
        <div class="w-full min-h-screen flex flex-col items-center justify-center bg-[url(images/pexels-thirdman-6194031.jpg)] text-white md:p-4" style="font-family: 'Poppins', sans-serif;">
          {content}
